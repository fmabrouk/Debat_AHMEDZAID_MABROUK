...
%\tableofcontents
	...
	\begin{tikzpicture}
		...
		\node [right=1cm of b,s,yshift=-1.5cm,xshift=-0.5cm](c){<<Specific Class 2>>\\Solution\\\line(1,0){150}\\private ArrayList<String> E\\\line(1,0){150}\\public void ajouteArgument(String)\\public void retireArgument(String)\\public boolean solutionAdmissible(Debat,int)\\public boolean solutionAdmissibleSansErreur(Debat,int)\\private boolean condition2(Debat,int)\\private boolean condition1(Debat,int)\\private boolean condition1SansErreur(Debat,int)\\private boolean condition2SansErreur(Debat,int)\\private boolean verif(int,String,debat)\\public void affichage()};
		\draw [r] (a)--(b);
		\draw [r] (a)--(c);
