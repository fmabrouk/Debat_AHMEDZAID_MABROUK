...
public class Solution {
  ...
  public void ajouteArgument(String arg) {
    if (E.contains(arg)) System.out.println(
      " Argument " + arg + " déjà dans la solution"
    ); else {
      E.add(arg);
    }
  }
  ...
  public void retireArgument(String arg) {
    if (!E.contains(arg)) System.out.println(
      " Argument " + arg + " n'est pas dans la solution"
    ); else {
      E.remove(arg);
    }
  }
    ...
    for (int i = 0; i < E.size(); i++) {
      for (int j = 0; j < E.size(); j++) {
        if (verif(E.get(i), E.get(j), g)) {
          System.out.println(
            "Il existe une contradiction entre " + E.get(i) + " et " + E.get(j)
          );
          return false;
        }
        if (verif(E.get(j), E.get(i), g)) {
          System.out.println(
            "Il existe une contradiction entre " + E.get(j) + " et " + E.get(i)
          );
          return false;
        }
      }
   ...
   * @param tailleGraphe l'argument qui contredit
