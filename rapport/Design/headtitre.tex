...
\begin{titlepage}
\raggedleft\includegraphics[scale=0.5]{téléchargement.png}
...
\vspace{1cm}
\begin{center}
 \textsc{\LARGE Université Paris Cité\\ \large L3 Informatique appliquée \\ \unskip\strut Programmation avancée et application
 } \vspace{-1.5ex} \\	
\end{center}
\vspace{3cm}
\begin{minipage}[t]{0.5\textwidth}
    \begin{flushleft}
        { \textbf{Auteurs :\\ MABROUK Fayez \& AHMED-ZAID Macyl}
...
\begin{minipage}[t]{0.5\textwidth}
    \begin{flushright}
        {\large \textit{Groupe de Td Lundi : 11H30 - 14H30 }}           
        \vspace*{0.5cm}
    \end{flushright}    
\end{minipage}%
